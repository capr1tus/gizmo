...
## about
Gizmo is a lightweight, retro emulation site, able to be hosted on any static hosting platform. Gizmo is easy to set up and start playing, with a sleek UI featuring the [Rosepine](https://rosepinetheme.com/palette/) theme. You can run Gizmo it completely offline, assuming you have your roms already downloaded.
